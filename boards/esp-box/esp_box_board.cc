...
#include "display/ds02_home_display.h"
...
private:
    ...
    void InitializeButtons() {
        boot_button_.OnClick([this]() {
            ...
            if (auto* home_display = dynamic_cast<home::Ds02HomeDisplay*>(display_)) {
                home_display->AdvanceStandbyButtonState();
                return;
            }
            app.ToggleChatState();
        });
    ...
    void InitializeIli9341Display() {
        ...
        display_ = new home::Ds02HomeDisplay(panel_io, panel,
